        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-icon">
                    <img src="./img/favicon.png" class="iconImg">
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="member" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/">會員管理</a>
                        <a class="collapse-item" href="/">會員活動</a>
                    </div>
                </div>
            </li>
            ...
            <!-- 好友系統 -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#friend"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fa-solid fa-user-group sidebaricon"></i>
                    <span>好友管理系統</span>
                </a>
                <div id="friend" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#product"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fa-solid fa-cart-shopping sidebaricon"></i>
                    <span>商品管理系統</span>
                </a>
            ...
            <!-- 遊戲系統 -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#game"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fa-solid fa-gamepad sidebaricon"></i>
                    <span>遊戲管理系統</span>
                </a>
                <div id="game" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#card"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fa-solid fa-wand-sparkles sidebaricon"></i>
                    <span>卡片管理系統</span>
                </a>
                <div id="card" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">卡片管理系統</h6>
                        <a class="collapse-item" href="/">卡片管理</a>
                        <a class="collapse-item" href="/">交易管理</a>
                    </div>
                </div>
            </li>
            ...
            <!-- 論壇系統 -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#forum"
                    aria-expanded="true" aria-controls="collapseTwo">
                ...
                <div id="forum" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/">公告管理</a>
                        <a class="collapse-item" href="/">貼文管理</a>
                    </div>
                </div>
            </li>
